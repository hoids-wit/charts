...
sudo microk8s helm install matrix-synapse . --set serverName=matrix.petecca.com --set wellknown.enabled=true

rm /mnt/matrix/data/* -r -f
sudo microk8s helm uninstall matrix-synapse -n default
